  ...
  return (
    <div className="monitor-dashboard__log">
      <div className="monitor-dashboard__log-header">
        <Text color="dim" variant="caption-heading">App Events</Text>
      </div>
      <div className="monitor-dashboard__log-rows">
        {recentEvents.length > 0 ? recentEvents.map((event) => (
          <div key={event.id} className="monitor-dashboard__log-row">
            <Text as="span" className="monitor-dashboard__log-time monitor-dashboard__value" color="dim" variant="numeric">
          ...
          <div className="monitor-dashboard__log-empty">
            <Text color="dim" variant="caption">No events yet</Text>
          </div>
        )}
      </div>
    </div>
